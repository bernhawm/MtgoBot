...
trade_button = wait_for_image(TRADE_BUTTON_IMAGE, confidence=0.6, timeout=None)
if trade_button:
    logger.info("Trade button detected!")
    # Snip the region around the trade button
    capture_region_around(trade_button, margin=50, save_path="trade_screen.png")
    return_username(screenshot="trade_screen.png",)
...
confirm_button = wait_for_image(CONFIRM_BUTTON_IMAGE, confidence=0.8, timeout=10)
if confirm_button:
    logger.info("Confirm button detected!")
    # Snip the region around the confirm button
    capture_region_around(confirm_button, margin=50, save_path="confirm_screen.png")
